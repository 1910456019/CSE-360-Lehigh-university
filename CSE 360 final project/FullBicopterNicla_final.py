...
if __name__ == "__main__":
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "kppyaw", 0.5) #2
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "kpz", 1.5)
    serial.send_preference(ROBOT_MAC, DataType_Float, "kdz", 1)
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "pitchOffset", 180) #degrees
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "bx_strength", -1)
